...
<body>
    ...
    <div class="container cont">
        ...
        <div id="piechart" style="width: 700px; height: 370px; margin-left:auto;"></div> 

        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            <form method="get" action="" style="margin-top:-300px; margin-left: 100px;">
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <form action="file/request.php" method="post">
                    ...
                    <td><input type="submit" name="requestb" class="btn btn-info" value="Request Sample"></td>
                    <td><input type="submit" name="requestp" class="btn btn-info" value="Request Sample"></td>
                    <?php } ?>
