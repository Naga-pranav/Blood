...
session_start();
  ...
  header('location:login.php');
    ...
    $rid = $_SESSION['rid'];
    $sql = "select plasmarequest.*, hospitals.* from plasmarequest, hospitals where rid='$rid' && plasmarequest.hid=hospitals.id";
    $result = mysqli_query($conn, $sql);
?>

<!DOCTYPE html>
<html>
<?php $title="Bloodbank | Sent Plasma Requests"; ?>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		...
		<tr>
			...
			<?php }
				...
				<a href="file/pcancel.php?reqid=<?php echo $row['reqid'];?>" class="btn btn-danger">Cancel</a>
			<?php } ?>
			</td>
		</tr>
		<?php } ?>
